...
visibili nel documento, nelle sezioni `Archivio dei commenti alla circolare «Qualificazione Servizi SaaS per il Cloud della PA» <http://test-cloud-pa.readthedocs.io/it/archivio-commenti/circolari/SaaS/archivio_commenti_SaaS.html>`_ e
`Archivio dei commenti alla circolare «Qualificazione dei Cloud Service Provider per servizi IaaS/PaaS» <http://test-cloud-pa.readthedocs.io/it/archivio-commenti/circolari/CSP/archivio_commenti_CSP.html>`_. Per maggiori informazioni,
consulta le `Istruzioni per la consultazione pubblica
